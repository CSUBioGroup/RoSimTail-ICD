...
def ans_test(test_dataloader,model):
    ...
    for t in list_threshold:
        ...
        print(f"prec_at_5: {metrics['prec_at_5']:.4f}, prec_at_8: {metrics['prec_at_8']:.4f}, prec_at_15: {metrics['prec_at_15']:.4f}")
...
#     #######################THRESHOLD SEARCH##########################
#     ma, opt_thr = -1, -1
#     for thr in np.linspace(0.35, 0.55, 10):
#         all_preds = []
#         all_preds_raw = []
#         all_labels = []
#         for step, batch in enumerate(test_dataloader):
